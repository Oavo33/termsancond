...
<body>
    ...
    <div class="section">
        ...
        <div class="section-content">
            <p>The Hub may contain links to third-party websites or resources that are not owned or controlled by us. We have no control over the content, privacy policies, or practices of these third-party websites, and we assume no responsibility for them.</p>
    ...
    <footer>
        <div class="footer-container">
            ...
            <div class="box">
                <h3>About Us</h3>
                <p>By using The Hub, you agree to our <a href="terms.html">Terms of Service</a> and <a href="privacy.html">Privacy Policy</a>. Please read them carefully before accessing or using our platform.</p>
            </div>
        </div>
        <div class="footer-container">
    ...
    <div class="footer-container">
        <p>&copy; 2023 The Community Business Hub . All rights reserved.</p>
    </div>
    <div class="tcbhg">
        <p>
